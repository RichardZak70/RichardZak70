# Richard Zakrzewski, P.Eng.

**Engineering Executive | Agentic AI Developer | Fractional CTO**

Four-time founder and electrical engineer (Queen's, P.Eng.) with 30+ years building hardware and automation companies, including scaling one from a basement startup to $30M+ revenue and 90+ employees. Today I design embedded products and industrial systems for manufacturers, and I build the agentic AI tooling that runs my own engineering and business operations end to end.

What I bring that's rare: I can take a product from schematic and firmware through certification and contract manufacturing, and I can build the Claude-based agents, MCP servers and data pipelines that make a small team operate like a large one.

## By the Numbers

- **$30M+** revenue built at a company I co-founded
- **90+** employees scaled; operations in Canada, the U.S. and Brazil
- **4** companies founded
- **30+** years of engineering experience
- **~100** repositories across my account and 7 GitHub organizations, 99 with commits in the past 12 months
...
- Led a live Python/FastAPI to Kotlin/Ktor backend migration on Azure Container Apps using a traffic-split canary cutover
- **Disability-Assist**, a sibling assistive-technology product on the same platform: voice AI, smart-home control and caregiver coordination for people with speech, cognitive or sensory barriers
- An AI-optimized engine for rebuilding small-business websites as fast Svelte + Tailwind sites
...
**AI and Software**: Python | TypeScript | Kotlin/Ktor | FastAPI | Svelte 5 | React | Shopify Hydrogen | Claude API | Claude Code | MCP | RAG | Azure Container Apps | Cloudflare

**Hardware and Embedded**: PCB design (KiCad, OrCAD X) | Analog/digital circuits | Raspberry Pi CM5 | Embedded Linux | PIC32 / Harmony 3 | Qt/PySide6 | Data acquisition | Signal integrity | Safety systems

**Automation**: PLC/HMI | Motion control | Robotics integration | Production line design | Test and inspection systems

**Business**: P&L management | ISO 9001 | Supply chain and sourcing | Cost engineering | Program management | Technical sales | Due diligence

## Available For

- Agentic AI development contracts
- Fractional CTO / VP Engineering
- Hardware and embedded product development
- Full-time executive roles

## Work Authorization

*Canadian citizen; eligible for U.S. employment under USMCA/TN professional status (Engineer). No visa sponsorship required.*

## Connect

- Website: [richardzak.com](https://richardzak.com)
- LinkedIn: [linkedin.com/in/richardzakrzewski](https://linkedin.com/in/richardzakrzewski)
